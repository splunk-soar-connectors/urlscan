...
URLSCAN_ERR_MESSAGE_UNAVAILABLE = "Error message unavailable. Please check the asset configuration and|or the action parameters."
...
URLSCAN_SERVER_CONNECTION_ERROR = "Error Connecting to server. Details: {}"
